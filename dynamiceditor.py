...
class DynamicEditor(QtGui.QWidget):
    ...
    def setupTabs(self, elmerDefs, section, ID):
        ...
        # get data that applies to all equations
        ...
        while self._element.isNull() is False:
            ...
            for x in range(0, 2):
                ...
                while self._param.isNull() is False:
                    ...
                    fullName = "/{}/{}/{}/".format(str(self._name.text()).strip(),
                                                   section, labelName, str(ID))
        ...
        self.nameEdit.setText("{} {}".format(section, str(ID)))
