...
class SifReader():
    ...
    def readSif(self, path):
        ...
        for idx, element in enumerate(self._ewh.solverParameterEditor):
            self._solvIds.update({str(element.solverName): idx})
    ...
    def _bcondition(self, block):
        ...
        self._ewh.boundaryConditionEditorFinishedSlot(1, count)
    ...
    def _icondition(self, block):
        ...
        self._ewh.initialConditionEditorFinishedSlot(1, sifID - 1)
    ...
    def _bforces(self, block):
        ...
        self._ewh.bodyForceEditorFinishedSlot(1, sifID - 1)
    ...
    def _materials(self, block):
        ...
        self._ewh.matEditorFinishedSlot(1, sifID - 1)
    ...
    def _equation(self, block):
        ...
        self._ewh.pdeEditorFinishedSlot(1, sifID - 1)
